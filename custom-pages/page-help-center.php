...
<body>
    ...
    <section class="common-inquiries">
        <div class="section-header">
            <h2 class="section-header-title">Not sure about something? Start here.</h2>
            <span class="section-header-line"></span>
            <a href="<?php echo get_permalink(get_page_by_path('contact')); ?>" class="section-header-link">Can't find your answer? Reach out →</a>
        </div>
    </section>
        ...
        <div class="faq-container">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Everything on Tinza is handcrafted from copper and brass — two materials chosen for their beauty, durability, and ability to grow more characterful with time.<br>
                        <br>
                        From kitchen and dining essentials to lighting, wall décor, and decorative accents, every piece is designed to bring warmth and intention to a space. You'll also find bathroom fixtures, cabinet hardware, and outdoor pieces for a more complete transformation.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Unique handcrafted pieces: No factory lines. No duplicates. Every item is handcrafted with its own personality, texture, and story.<br>
                        <br>
                        Made by exceptional artisans: Real people with generations of skill, shaping copper and brass into generational décor built to be passed down.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Head to the bottom of any page and click Contact Us to reach our support team directly.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Buying on Tinza is simple. Here's how:<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Connecting directly with artisans is simple. Here's how:<br>
                        <br>
                        ...
                        4. Wait for a reply — The artisan will respond directly to your inbox, usually within 24–48 hours.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        You can check your order status anytime in just a few steps:<br>
                        <br>
                        1. Log into your account — Head to My Account > Orders.<br>
                        2. Find your order — Click on it to see its current status and details.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Finding the perfect copper or brass piece is simple.<br>
                        <br>
                        ...
                        Browse by category from the main menu: Kitchen & Dining, Lighting, Wall Art, and more.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        It depends on where your order is in the process.<br>
                        <br>
                        Haven't placed an order yet? Head to My Account > Addresses, click Edit next to your shipping address, update your details, and save.<br>
                        <br>
                        Order placed but not yet shipped? Reach out to the artisan immediately through your order page and ask them to update the address. Most artisans can accommodate the change as long as the order hasn't been prepared for shipping yet.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        It depends on where you are and where your artisan ships from.<br>
                        <br>
                        Domestic orders (same country as the artisan): Standard local sales tax or VAT is applied at checkout. No additional customs fees.<br>
                        <br>
                        International orders: Your local customs office may charge duties, import taxes, or handling fees upon arrival. These charges are the buyer's responsibility and are not included in the item price or shipping cost shown on Tinza.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Shipping times vary depending on the artisan's location and whether your item is ready-made or custom-crafted.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        All Tinza products are handcrafted, meaning no two pieces are exactly alike.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Absolutely! Tinza offers a personalized customization experience where you can collaborate directly with our artisans to bring your vision to life.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Because custom and made-to-order items are crafted specifically for you, they are generally not eligible for return.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Return policies vary by seller, but most items are eligible for return as long as they are unused, in their original condition, and returned within the seller's specified timeframe.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        If your item arrives damaged, incorrect, or not as described, don't worry — we've got you covered.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Depending on your country, your order may be subject to customs duties, taxes, or import fees upon arrival.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        ...
                        - Alignment with Tinza's vision and values.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Because Tinza works with independent artisans, warranty terms may vary slightly by seller. What remains constant is our commitment — every product is held to the same high standards of quality and craftsmanship.<br>
                        <br>
                        If something isn't right with your item, we'll work with you to find a fair solution.<br>
                        <br>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer searchable-item">
                    <p>
                        Warranty coverage varies by seller, but here's what is generally included and excluded:<br>
                        <br>
                        What's covered:<br>
                        - Manufacturing defects<br>
                        - Structural issues affecting the functionality of the piece<br>
                        - Damage that occurred during shipping<br>
                        <br>
    ...
    <section class="support-section">
        ...
        <p>
            Try rephrasing your search, or reach out and a real person will help you out.
        </p>
...
<script>
    ...
    // Store original HTML for each item (for highlight reset)
    ...
    function searchFunction() {
        ...
        const commonInquiries = document.querySelector('.common-inquiries'); // add this
        ...
        if (!filter) {
            ...
            if (msg) msg.remove();
            // Restore common inquiries when search is cleared
        ...
        // Hide common inquiries when searching
